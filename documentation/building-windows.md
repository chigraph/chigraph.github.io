...
* [Visual Studio](https://visualstudio.com) 2015 (2017 may work, not tested yet)
* [CMake](https://cmake.org) 3.0+ (3.1 suggested)
* [LLVM](https://llvm.org) 3.5+ (4.0 suggested). This pretty much needs to be compiled manually, you need development libraries. You can also use [prepackaged LLVM builds](https://github.com/chigraph/chigraph/releases/tag/dependencies)
